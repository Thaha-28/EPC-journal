  ...
  return (
    <JournalLayout>
      <div className="border-b border-border bg-[#f8f9fb] px-6 py-3 flex items-center gap-2 text-xs">
        ...
        <span className="font-medium text-[#1C1D1E]">Current Issue</span>
      </div>
      ...
      <div className="px-6 sm:px-8 py-6">
        ...
        <h1 className="mt-3 font-display text-2xl font-bold text-[#1C1D1E]">{issue.title}</h1>
        ...
        <div className="mt-3 flex flex-wrap gap-2 text-xs">
          {issue.volume && <span className="rounded-full bg-[#1C1D1E] px-2.5 py-1 font-semibold text-white">Volume {issue.volume}</span>}
          {issue.number && <span className="rounded-full bg-[#eef2f7] px-2.5 py-1 font-semibold text-[#1C1D1E]">Number {issue.number}</span>}
          {issue.datePublished && (
      ...
      <div className="border-t border-border bg-[#f8f9fb] px-6 sm:px-8 py-4">
        <div className="flex items-center justify-between">
          <h2 className="text-xs font-bold tracking-widest uppercase text-[#1C1D1E]">In this issue</h2>
      ...
      <div className="border-t border-border px-6 py-3 flex items-center justify-between bg-white text-xs">
        <Link href="/archives" className="font-semibold text-[#1C1D1E] hover:underline">
          Browse all issues
        </Link>
        <span className="text-muted-foreground">Continuous publication</span>
      </div>
