    ...
    <header className="w-full bg-white">
        ...
        <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-5 py-4">
            <Link href="/" className="flex items-center gap-3 shrink-0">
              ...
              <span className="sm:hidden flex h-9 w-9 items-center justify-center bg-[#005274] text-white font-bold text-sm rounded">E</span>
            ...
            <button
              ...
              className="inline-flex lg:hidden h-9 w-9 items-center justify-center border border-[#D8D9DA] rounded bg-white text-[#005274] ml-auto"
            >
      ...
      <nav aria-label="Primary" className="hidden lg:block bg-white border-b border-[#D8D9DA] sticky top-0 z-30">
        <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-8 flex items-center h-10 gap-0.5 text-sm overflow-x-auto">
          <Link href="/" className="shrink-0 px-3 py-2 text-sm font-bold text-[#005274] border-b-2 border-[#005274] -mb-px bg-[#F8F9FA]">
            Journal Home
          </Link>
          <Link href="/current" className="shrink-0 px-3 py-2 text-sm font-medium text-[#2F3032] hover:text-[#005274] hover:bg-[#F8F9FA] rounded">
            Current Issue
          </Link>
          <Link href="/archives" className="shrink-0 px-3 py-2 text-sm font-medium text-[#2F3032] hover:text-[#005274] hover:bg-[#F8F9FA] rounded">
            All Issues
          </Link>
          <Link href="/aims-scope" className="shrink-0 px-3 py-2 text-sm font-medium text-[#2F3032] hover:text-[#005274] hover:bg-[#F8F9FA] rounded">
            Aims and Scope
          </Link>
          ...
          <div className="relative shrink-0" onMouseEnter={() => setAboutOpen(true)} onMouseLeave={() => setAboutOpen(false)}>
            <button
              ...
              className="inline-flex items-center gap-1 px-3 py-2 text-sm font-medium text-[#2F3032] hover:text-[#005274] hover:bg-[#F8F9FA] rounded"
            >
              About
          ...
          <Link href="/editorial-board" className="shrink-0 px-3 py-2 text-sm font-medium text-[#2F3032] hover:text-[#005274] hover:bg-[#F8F9FA] rounded">
            Editorial Board
          </Link>
          <Link href="/open-access" className="shrink-0 px-3 py-2 text-sm font-medium text-[#2F3032] hover:text-[#005274] hover:bg-[#F8F9FA] rounded">
            Open Access
          </Link>
            ...
            <form action={getOjsUrl(siteConfig.ojsLinks.search)} method="get" target="_blank" className="flex items-center" role="search">
              <div className="relative">
                <input
                  ...
                  className="h-8 w-52 rounded-l border border-[#C2C3C6] bg-white px-3 pr-8 text-sm placeholder:text-[#767676] outline-none focus:border-[#005274] focus:ring-1 focus:ring-[#005274]/20"
                />
              ...
              <button type="submit" className="h-8 rounded-r bg-[#005274] px-3 text-xs font-semibold text-white hover:bg-[#003e57] border border-[#005274] border-l-0">
                Search
              </button>
            </form>
          </div>
      ...
      {mobileOpen && (
        <nav aria-label="Mobile" className="lg:hidden border-t border-[#D8D9DA] bg-[#F8F9FA]">
          <div className="mx-auto max-w-[1600px] px-4 py-3 flex flex-col text-sm">
            <Link href="/" onClick={() => setMobileOpen(false)} className="px-3 py-2.5 font-bold text-[#005274] bg-white rounded border border-[#D8D9DA] mb-1">
              Journal Home
            </Link>
            ...
            <div className="mt-3 grid grid-cols-2 gap-2">
              <Link href={getOjsUrl(siteConfig.ojsLinks.login)} target="_blank" rel="noopener noreferrer" className="inline-flex justify-center rounded border border-[#D8D9DA] bg-white px-4 py-2.5 text-sm font-semibold text-[#005274]">
                Log in
              </Link>
              <Link href={getOjsUrl(siteConfig.ojsLinks.submission)} target="_blank" rel="noopener noreferrer" className="inline-flex justify-center rounded bg-[#005274] px-4 py-2.5 text-sm font-semibold text-white">
                Submit
              </Link>
            </div>
            <Link href="/contact" onClick={() => setMobileOpen(false)} className="mt-2 flex justify-center rounded border border-[#D8D9DA] bg-white px-4 py-2 text-sm font-semibold text-[#005274]">
              Contact
            </Link>
          </div>
        </nav>
